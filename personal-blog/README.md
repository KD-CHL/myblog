...
| 浅色主题 | 深色主题 |
| :---: | :---: |
| ![首页·浅色](./docs/screenshots/home-light.png) | ![首页·深色](./docs/screenshots/home-dark.png) |
...
![全局搜索浮层](./docs/screenshots/search-overlay.png)
...
前端为 React 19 + Vite 6 的零依赖自绘路由 SPA；后端为零运行时依赖的 Node 22 原生 HTTP 服务，本地使用 SQLite，生产使用 Turso/libSQL。详细设计见 [架构说明](./docs/ARCHITECTURE.md) 和 [迁移与部署](./docs/MIGRATION_AND_DEPLOYMENT.md)。
